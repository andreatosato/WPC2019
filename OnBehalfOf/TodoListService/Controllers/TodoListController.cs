...
namespace TodoListService.Controllers
{
    ...
    public class TodoListController : Controller
    {
        ...
        /// </summary>
        static readonly string[] scopeRequiredByApi = new string[] { "access_as_user", "WPC2019-API" };
        ...
        public IEnumerable<TodoItem> Get()
        {
            ...
            var claims = User.Claims.Select(x => x.Type + " : " + x.Value).Aggregate((current, next) => current + Environment.NewLine + next);
